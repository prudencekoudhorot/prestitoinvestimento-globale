<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <link rel="stylesheet" href="{{asset('fontawesome5/css/fontawesome.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('fontawesome5/css/all.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('fontawesome5/css/regular.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('fontawesome5/css/solid.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('fontawesome5/css/brands.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('fontawesome5/css/v4-shims.min.css')}}" rel="stylesheet">
